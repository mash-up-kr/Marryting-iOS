...
public enum DesignSystemAsset {
  public enum Assets {
    ...
    public static let icHeartBlack = DesignSystemImages(name: "ic_heart_black")
    public static let icHeartRed = DesignSystemImages(name: "ic_heart_red")
    public static let icLeftArrowEnable = DesignSystemImages(name: "ic_left_arrow_enable")
    public static let icLeftArrowHighlight = DesignSystemImages(name: "ic_left_arrow_highlight")
    public static let icRightArrowDisable = DesignSystemImages(name: "ic_right_arrow_disable")
    public static let icRightArrowEnableBlack = DesignSystemImages(name: "ic_right_arrow_enable_black")
    public static let icRightArrowEnableWhite = DesignSystemImages(name: "ic_right_arrow_enable_white")
    public static let icRightArrowHighlightGreen = DesignSystemImages(name: "ic_right_arrow_highlight_green")
    public static let icRightArrowHighlightRed = DesignSystemImages(name: "ic_right_arrow_highlight_red")
